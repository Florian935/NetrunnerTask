...
| US-033 | Achievements-récompenses + aperçu de collection (voie déterministe) | A3 | moyenne | fait | US-031, jalons (US-028) |
| US-034 | Caisses & rituel d'ouverture (3 qualités, tables de probas, voie aléatoire) | A3 | moyenne | fait | US-031 |
| US-035 | Pity + fragments anti-doublon (approfondit les caisses) | A3 | basse | fait | US-034 |
