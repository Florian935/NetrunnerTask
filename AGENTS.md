# AGENTS.md — Constitution du projet Netrunner Tasks

> Codex lit ce fichier au début de **chaque** session. Il prime sur toute
...
5. **[Optionnel — impact UI significatif] Design** — si l'US touche
   ...
   attendre que je fournisse la maquette (Codex Design).
   → **STOP, validation de la maquette.**
   _C'est à toi de détecter quand cette étape s'applique et de me la proposer._
