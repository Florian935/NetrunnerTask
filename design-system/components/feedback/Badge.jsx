...
.nt-badge--soft{background:color-mix(in srgb,var(--_c) 20%,transparent);color:var(--_c);border-color:color-mix(in srgb,var(--_c) 55%,transparent);box-shadow:0 0 0 1px color-mix(in srgb,var(--_c) 30%,transparent),0 0 12px color-mix(in srgb,var(--_c) 50%,transparent);text-shadow:0 0 6px color-mix(in srgb,var(--_c) 55%,transparent);}
.nt-badge--solid{background:var(--_c);color:var(--bg-app);box-shadow:0 0 14px color-mix(in srgb,var(--_c) 65%,transparent);}
.nt-badge--outline{background:transparent;color:var(--_c);border-color:color-mix(in srgb,var(--_c) 60%,transparent);box-shadow:0 0 12px color-mix(in srgb,var(--_c) 45%,transparent);text-shadow:0 0 6px color-mix(in srgb,var(--_c) 50%,transparent);}
`;
