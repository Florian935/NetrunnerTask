...
/** Interrupteur pilule pour un réglage binaire à effet immédiat ; dégradé mint + halo quand actif. */
export function Switch({
  ...
  style = {},
  ...rest
}: SwitchProps & Omit<LabelHTMLAttributes<HTMLLabelElement>, keyof SwitchProps>) {
